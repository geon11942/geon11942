...
public class Equipment : MonoBehaviour
{
    ...
    [SerializeField]
    ItemDataTable[] _itemData = new ItemDataTable[3];
    bool HandOn = false;
    bool BodyOn = false;
    bool HeadOn = false;
    void Start()
    ...
    public ItemDataTable UseEquipItem(ItemDataTable item)
    {
        switch (item.Equip_Type)
        {
            case EquipType.Hand:
                if(HandOn)
                {
                    ItemDataTable Idata =_itemData[0];
                    _itemData[0] = item;
                    EquipSet(0);
                    return Idata;
                }
            ...
            case EquipType.Body:
                if (BodyOn)
                {
                    ItemDataTable Idata = _itemData[1];
                    _itemData[1] = item;
                    EquipSet(1);
                    return Idata;
                }
            ...
            case EquipType.Head:
                if (HeadOn)
                {
                    ItemDataTable Idata = _itemData[2];
                    _itemData[2] = item;
                    EquipSet(2);
                    return Idata;
                }
    ...
    void EquipSet(int s_slotnum)
    {
        ...
        SlotImages[s_slotnum].gameObject.GetComponent<Image>().sprite = _itemData[s_slotnum].Item_Image;
